...
<script type="text/javascript">
        ...
        $('#InventarioTableContainer').jtable({
            title: 'Inventario',
            toolbarsearch: true,
            paging: true, //Enable paging
            pageSize: 5, //Set page size (default: 10)
            sorting: true, //Enable sorting
            defaultSorting: 'codigo_material ASC',
            toolbar: {
                items: [{
            ...
            actions: {
                listAction: 'CRUDInventario?action=list',
                createAction:'CRUDInventario?action=create',
                updateAction: 'CRUDInventario?action=update',
                //deleteAction: 'CRUDInventario?action=delete'
            },
            fields: {
                codigo_material: {
                    title: 'Codigo',
                ...
                grupo_material: {
                    ...
                    inputClass: 'validate[required,custom[material]]'	
                ...
                costeporunidad: {
                    ...
                    width: '20%',
                    edit: true,
                    inputClass: 'validate[required,custom[integer],min[0],maxSize[20]]'
                },
         ...
         $('#InventarioTableContainer').keyup(function(e){
       	 $('#InventarioTableContainer').jtable('load', {
       		 searchCodigo: $('#jtable-toolbarsearch-codigo_material').val(),
           	 searchNombre: $('#jtable-toolbarsearch-nombre').val(),
           	 searchGrupo: $('#jtable-toolbarsearch-grupo_material').val(),
           	 searchCantidad: $('#jtable-toolbarsearch-cantidad').val(),
           	 searchPrecio: $('#jtable-toolbarsearch-costeporunidad').val(),      	 
            }); 
       	});
         $('#InventarioTableContainer').change(function(e){
           	 $('#InventarioTableContainer').jtable('load', {
         		 searchCodigo: $('#jtable-toolbarsearch-codigo_material').val(),
               	 searchNombre: $('#jtable-toolbarsearch-nombre').val(),
               	 searchGrupo: $('#jtable-toolbarsearch-grupo_material').val(),
         ...
         $resetbutton.click(function(){
           	 $('#InventarioTableContainer').jtable('load', {
                 ...
                 searchGrupo: "0",
           		...
           		$('#jtable-toolbarsearch-grupo_material').val("0");
				 });
         $('#tableToExcelJQuery').click(function (e) {
        	...
        	// Se crea Temporalmente una tabla basada en la Tabla Creada en JQUERY (la Jtable)
        	var htmltable = $('#InventarioTableContainer'); // here is the Name of your JTable Name ID
        ...
        $('#InventarioTableContainer').keyup();
    });
</script>
...
<ul class="glossymenu">
   ...
   <li class='current'><a href='inventarioO.jsp'><b>Inventario</b></a></li>
